# Stock OrderedSet from a python cookbook.
#
# Thanks to Ramphoryncus from freenode's #python who pointed me at it
# and also wrote it in the first place :)
#
# We use it as a work queue - append to the right, pop from the left,
# never have an item in the queue more than once.
